...
write_csv(flux_target_daily, "terrestrial_daily_tern-targets.csv.gz")
...
aws.s3::put_object(file = "terrestrial_daily_tern-targets.csv.gz", 
                   object = "terrestrial_daily/terrestrial_daily_tern-targets.csv.gz",
                   bucket = "neon4cast-targets")
